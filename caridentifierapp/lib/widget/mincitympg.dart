...
class MinCityMpgItemWidget extends StatelessWidget {
  final CarModel car; // Assuming CarModel is the class for your car data

  MinCityMpgItemWidget({required this.car, Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          CustomImageView(
            imagePath: "assets/images/speedometer1.png", // Use car properties
            height: 60.0,
            width: 60.0,
          ...
          Text(
            "Min City MPG: ${car.minCityMpg}", // Use car properties
